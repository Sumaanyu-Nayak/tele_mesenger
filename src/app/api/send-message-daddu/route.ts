...
export async function POST(req: NextRequest) {
  try {
    ...
    const chatId = process.env.TELEGRAM_DADDU_CHAT_ID;
    if (!botToken || !chatId) {
      throw new Error('Missing Telegram bot token or daddu chat ID');
    }
    ...
    // Store the sent message in MongoDB with fromWeb: true and chatType: 'daddu' and username 'You'
